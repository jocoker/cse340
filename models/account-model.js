...
async function updateAccount(account_id, account_firstname, account_lastname, account_email) {
  try {
    ...
    throw new Error("Database error during account update: " + error)
  }
}
...
async function updatePassword(account_id, hashedPassword) {
  try {
    ...
    throw new Error("Database error during password update: " + error)
  }
}
...
async function getAccountById(account_id) {
  try {
    ...
    throw new Error("Database error during account lookup: " + error)
  }
}
